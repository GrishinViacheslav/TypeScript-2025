...
if (confirm("Почати тестування?")) {
  ...
  interface ScoresManager extends StudentJournal {
    getAllScores(this: ScoresManager):number[]
    getAvgScore(this: ScoresManager):number
    getMaxScore(this: ScoresManager):number
  }

  const pupilJournal:ScoresManager = {
